				...
				<Card style={{
					...
					<CardContent>
						<Stack spacing={2}>
							...
							<DesktopDatePicker label="Date" inputFormat="dd/MM/yyyy" value={value} onChange={handleChange}
							...
							<Divider variant="middle"></Divider>
							<TextField id="outlined-multiline-static" label="Andre kommentarer" multiline rows={3}/>
							<Divider variant="middle"></Divider>
							<div style={{
								marginTop: '5px',
								display: 'flex',
